...
public interface IMap {
	...
	/**
	 * Setzt in allen Feldern den Feuerwert hoch in Abhängigkeit des
	 * übergebenden Grades.
	 * 
	 * @param grad
	 *            Von Richtung.NORTH im Uhrzeigersinn
	 ...
	 * @return true Position erfolgreich eingetragen <br>
	 *         false Roboter war schon auf gesetzter Position oder Position
	 *         nicht in der Map
	 */
	 ...
	 * @param y
	 *            Position auf der y Achse
	 * @return true wenn sich ein Hinderniss auf Position (x,y) befindet
	 */
	 ...
	 * @param y
	 *            Position auf der y Achse
	 * @return Feuerwert von 0 bis 127
	 */
